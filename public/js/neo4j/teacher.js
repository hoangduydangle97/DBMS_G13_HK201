...
$('#add-btn').click(function(){
    ...
    $.post(
        'http://localhost:3000/neo4j/ajax/teacher/add-btn',
        {},
        function(result, status){
            if(status == 'success'){
                if(result == 'error'){
                    location.href = 'http://localhost:3000/neo4j/school/teacher/error';
                }
                else{
                    $('table').before(result);
                }
...
$('#search-input').keyup(function(){
    var text = $(this).val();
    $.post(
        'http://localhost:3000/neo4j/ajax/teacher/search',
        {
            text: text
        },
        function(result, status){
...
function updateBtn(id){
    ...
    $.post(
        'http://localhost:3000/neo4j/ajax/teacher/update-btn',
        {
            id: id
        },
        function(result, status){
...
function cancelBtn(id){
    $.post(
        'http://localhost:3000/neo4j/ajax/teacher/cancel-btn',
        {
            id: id
        },
        function(result, status){
...
function addTeacher(){
    ...
    $.post(
        'http://localhost:3000/neo4j/teacher/add',
        {
            id: id_teacher,
            name: name_teacher,
            age: age_teacher
...
function updateTeacher(id){
    ...
    var age_teacher = $('#age-teacher-input').val();
    $.post(
        'http://localhost:3000/neo4j/teacher/update',
        {
            old_id: id,
            new_id: id_teacher,
            name: name_teacher,
...
function delTeacher(field, id){
    $.post(
        'http://localhost:3000/neo4j/teacher/delete',
        {
            field: field,
            id: id
        },
